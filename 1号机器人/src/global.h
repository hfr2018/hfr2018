...
ball_dis4robot = fabs(0.000604*r*r*r+0.01113*r*r-6.736*r+252);//3
...
extern IplImage *show_Image,*Image,* pImage,*ball_Image,*ball_Image_gray,*field_Image,*field_Image_gray,*goal_canny_Image,*goal_color_dst,*goal_Image_gray,*goal_Image;
extern CvSeq *cont;
