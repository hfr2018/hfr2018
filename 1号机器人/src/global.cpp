...
int white_points_up_1 = 300;
int green_points_low_1 = 5;
int green_points_up_1= 90;
int white_points_low_3 = 100;
int white_points_up_3 = 400;
int green_points_low_3 = 5;
int green_points_up_3= 90;
CvCapture* capture;
IplImage *show_Image,*Image,* pImage,*ball_Image,*ball_Image_gray,*field_Image,*field_Image_gray,*goal_canny_Image,*goal_color_dst,*goal_Image_gray,*goal_Image; 						//HSVImagegray和white_cvtImage分别是匹配完绿色和白色的灰度图
