...
double hipRollCompensation = 0.4* PI / 180; //左右摇摆可改变此参数
...
double hipShift[2] = { 0.85*PI/180,0.45*PI/180 };  //0控制前后+前-后；1控制左右 -左+右
double hipShift3 = 0.5*PI/180;    //控制左右转动     +右转且平移 -左转且平移//TODO 不 合理
